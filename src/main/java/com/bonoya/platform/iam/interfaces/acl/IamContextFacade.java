package com.bonoya.platform.iam.interfaces.acl;
...
import com.bonoya.platform.iam.domain.model.queries.GetUserByIdQuery;
...
public class IamContextFacade {
    ...
    public Long createUser(String username, String password) {
        var signUpCommand = new SignUpCommand(username, password, List.of(Role.getDefaultRoleName()));
    ...
    public Long createUser(String username, String password, List<String> roleNames) {
        var roles = roleNames != null ? roleNames.stream().map(Role::toRoleNameFromString).toList() : List.of(Role.getDefaultRoleName());
